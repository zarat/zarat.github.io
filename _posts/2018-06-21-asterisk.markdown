...
Sollte hier ein Fehler auftauchen, das das Paket <code>libjansson</code> benötigt wird, installieren Sie es über das apt tool.

<pre>
apt install libjansson*
</pre>

<b>EDIT</b> Oder das configure script mit dem zusätzlichen Parameter <code>./configure --with-libjansson</code>.

Nun sollte das <code>./configure</code> keinen Fehler mehr ausgeben.
