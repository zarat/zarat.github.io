...
permalink: /about/
---
Willkommen zu meinem Github Blog. Mein Profil finden Sie unter [github.com/zarat](https://github.com/zarat). Nachrichten bitte an: <span style="color: lightblue" id="no-spam">jane.doe@badmail.com</span>. Um Spam zu vermeiden wird die korrekte Adresse nur bei aktiviertem Javascript angezeigt!
